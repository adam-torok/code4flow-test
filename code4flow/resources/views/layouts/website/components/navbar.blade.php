  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
      ...
      <ul class="navbar-nav ml-auto w-100 mb-2 mb-lg-0">
        <a href="{{route('landing')}}" class="nav-item nav-link d-flex"> <i class="fas fa-home mx-2 d-block"></i>Főoldal</a>
        <a href="{{route('poems')}}" class="nav-item nav-link d-flex"><i class="fas fa-book mx-2 d-block"></i> Versek</a>
        
        @auth    
        <a href="{{route('user-poems.index')}}" class="nav-item nav-link d-flex"><i class="fas fa-pen-fancy mx-2 d-block"></i> Verseim</a>
        @endauth
        ...
        <div class="w-100 justify-content-end navbar-nav ml-auto">
          ...
          <ul class="dropdown-menu  border-0 shadow rounded" aria-labelledby="navbarDropdown">
            <a href="{{route('profile')}}" class="dropdown-item"><i class="fas fa-user"></i> Profil</a>
            <a href="{{route('reports.index')}}" class="dropdown-item"><i class="fas fa-bug"></i> Hiba bejelentése</a>
