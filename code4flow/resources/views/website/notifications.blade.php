                        ...
                        <div class="p-3 d-flex align-items-center border-bottom">
                            <div class="font-weight-bold mr-3">
                                <div>
                                    ...
                                    <a href="{{route('user-poems.edit',$notification->data['id'])}}">{{$notification->data['title']}}</a> című költeményed új állapota: 
                        ...
                        <div class="p-3 d-flex align-items-center border-bottom">
                            <div class="font-weight-bold mr-3 ">
                                <div>
                                    ...
                                    <a href="{{route('reports.edit',$notification->data['id'])}}">{{$notification->data['title']}}</a>
